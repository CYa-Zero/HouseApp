...
-(void)showAlertAdded{
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Congratulations!" message:@"This property has been added to your favorite list!" preferredStyle:UIAlertControllerStyleAlert];
